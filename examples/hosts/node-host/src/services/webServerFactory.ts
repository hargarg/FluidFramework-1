...
export class SocketIoSocket implements IWebSocket {
...
export class SocketIoServer extends EventEmitter implements IWebSocketServer {
...
export class WebServerFactory implements IWebServerFactory {
    ...
    public create(requestListener: RequestListener): any {
